...
const CONFIG = {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=ZVvmLakUtXE",
    textos: {
        cat1: { t: "QUIÉNES SOMOS", c: "URBAN MOTO redefine la movilidad y la pasión sobre dos ruedas en la región, ofreciendo motocicletas de alta ingeniería, agilidad urbana, seguridad de vanguardia y un diseño sofisticado que eleva la experiencia de rodar al máximo nivel." },
        cat2: { t: "EXCELENCIA", c: "Explora nuestra gama de servicios especializados: Venta de motocicletas de la línea URBAN MOTO, planes de financiamiento a tu medida, pruebas de manejo (Test Drive), taller mecánico certificado con refacciones originales y una línea completa de accesorios y cascos de seguridad." },
        cat3: { t: "CLIENTES FELICES", c: "Nuestra prioridad es la excelencia en el servicio. Motociclistas y entusiastas de Aguascalientes respaldan la calidad, la potencia y el desempeño excepcional que solo la ingeniería y el respaldo de URBAN MOTO pueden ofrecer." }
    },
    sucursales: {
